...
(function (d3$1) {
    ...
    const render = (graph) => {
        ...
        var node = svg
            ...
            .on('mouseover', highlightConnectedLinks)
        ...
        node
            ...
            .append('title')
            .text(function (d) {
                var incomingSum = d3.sum(d.targetLinks, function(l) { return l.value; });
                var [attribute, value] = d.name.split('-');
        ...
        const legend = svg.append("g")
            .attr("class", "legend")
            .attr("transform", `translate(${width - legendWidth - margin.right}, ${height - margin.bottom + 5.5})`);

        // 为每个属性创建一个图例项
        Object.keys(colorScales).forEach((attribute, i) => {
            ...
            legendItem.append("rect")
                ...
                .style("fill", colorScales[attribute][0]);
